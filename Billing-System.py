...
class Bill_App:
    def __init__(self,root):
        ...
        self.root.title("BILLING SYSTEM PYTHON PROJECT")
        title=Label(self.root,text="BILLING SYSTEM PYTHON PROJECT",bd=12,relief=RIDGE,font=("Arial Black",20),bg="#A569BD",fg="white").pack(fill=X)
        #===================================variables=======================================================================================
        self.nutella=IntVar()
        self.noodles=IntVar()
        self.lays=IntVar()
